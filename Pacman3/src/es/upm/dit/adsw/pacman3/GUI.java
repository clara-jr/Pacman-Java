...
public class GUI
    ...
    private void pintaCasilla(Graphics g, int x, int y) {
        ...
        pintaTipo(g, casilla);
        if (casilla.isObjetivo()) pintaImagen((Graphics2D) g, loadImage("Cama.png"), x, y);
        ...
        if (movil!= null && movil.getCasilla().isObjetivo()) pintaImagen((Graphics2D) g, movil.getImagen(), x, y);
    }
	...
	protected java.awt.Image loadImage(String fichero) {
